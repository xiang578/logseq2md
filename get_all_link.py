...
class linkQuence:
    ...
    def get_unvisited_size(self):
        return len(self.unvisited)

    def get_visited_size(self):
        return len(self.visited)
...
class Spider():
    ...
    def crawler(self):
        while not self.linkQuence.unvisitedurlsempty():# 若未访问队列非空
            ...
            print("visit_size: {}, unvisit_size: {}, check: {}".format(self.linkQuence.get_visited_size(), self.linkQuence.get_unvisited_size(), visitedurl))
